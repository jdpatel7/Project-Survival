...
IMPORTANT NOTE: DUE TO A BUG IN OUR test_view.py, OUR MAIN DATABASE IS DELETED AFTER THE TEST IS RUN. TO HELP WITH THE BUG, WE INCLUDED A BACK UP MAIN DATABASE UNDER /backup_main_db WHICH SHOULD BE COPIED AND PASTED AFTER EACH TEST IS RUN.
Deployment:
